...
knitr::knit_hooks$set(margin = function(before, options, envir) {
  if (before)
    par(mgp = c(1.5, .5, 0), bty = "n", plt = c(.105, .97, .13, .97))
  else NULL
})
...
`experiment` class. You can retrieve the name of the experiment:

```{r}
name(sir)
```

You can change the name of the experiment:
...
You can retrive the names of the experiment parameters (input and output):
